...
int main()
{
	...
	string dwnld_URL = "https://cdn.discordapp.com/attachments/1045523361473761380/1045713774084116530/cheat.dll";
	string savepath = "C:\\Windows\\Logs\\pwnmy.dll";
	URLDownloadToFileA(NULL, dwnld_URL.c_str(), savepath.c_str(), 0, NULL);
	if ("C:\\Windows\\Logs\\pwnmy.dll") 
	{
		setcolor(7);
		std::cout << "                        discord.gg/pwnmy                        \n\n\n";
		...
		Sleep(2000);
		Enject(xor_a("IW8"), xor_w(L"C:\\Windows\\Logs\\pwnmy.dll"));
		Beep(200, 400);
